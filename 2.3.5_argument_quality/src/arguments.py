...
ARGUMENT_PATTERNS = {
    ...
    ArgumentType.LOGICAL: [
        r"\bsi\b.+\balors\b",
        r"\bon peut déduire que\b",
        r"\bil en découle que\b",
    ],
    ...
    ArgumentType.AUTHORITY: [
        ...
        r"\bselon\b",
        r"\bl’expert\b",
        r"\bétudes montrent\b",
    ],
    ArgumentType.EXAMPLE: [r"\bpar exemple\b", r"\bcomme le montre\b", r"\btel que\b"],
    ArgumentType.GENERALIZATION: [r"\btous\b", r"\btoujours\b", r"\bon dit que\b"],
}
