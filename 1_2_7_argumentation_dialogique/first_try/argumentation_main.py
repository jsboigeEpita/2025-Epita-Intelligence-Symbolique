...
class ArgumentationAgent:
    ...
    async def generate_argument(
        self, debate_state: DebateState, argument_type: str = "claim"
    ) -> Argument:
        ...
        try:
            response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are participating in a structured debate. Provide clear, logical arguments.",
                    },
...
class DebateModerator:
    ...
    async def run_debate(
        self, topic: str, agents: List[ArgumentationAgent], max_turns: int = 10
    ) -> DebateState:
    ...
    def _determine_argument_type(
        self, debate_state: DebateState, agent: ArgumentationAgent
    ) -> str:
