...
class MultiAgentDialogueSystem:
    ...
    def create_dialogue(self, 
                       ...
                       agent2_id: str, 
                       topic: str,
                       dialogue_type: DialogueType = DialogueType.INQUIRY) -> str:
    ...
    def _create_dialogue_summary(self, dialogue_id: str, agent1: DialogueAgent, agent2: DialogueAgent) -> Dict[str, Any]:
        """Crée un résumé complet du dialogue"""
        all_moves = sorted(
            agent1.dialogue_history + agent2.dialogue_history,
