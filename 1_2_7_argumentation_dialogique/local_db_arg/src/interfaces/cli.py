...
class DialogueSystemCLI:
    ...
    def _create_test_agents(self):
        ...
        kb1.add_proposition(
            Proposition("Les émissions de CO2 ont augmenté depuis 1950", True, 0.95)
        )
        kb1.add_proposition(
            Proposition("Les températures moyennes augmentent", True, 0.9)
        )
        ...
        kb2 = KnowledgeBase()
        kb2.add_proposition(
            Proposition("Les variations climatiques sont naturelles", True, 0.7)
        )
        kb2.add_proposition(
            Proposition("Les modèles climatiques sont imprécis", True, 0.6)
        )
        kb2.add_proposition(
            Proposition("L'activité solaire influence le climat", True, 0.8)
        )
    ...
    def _create_dialogue(self):
        ...
        try:
            ...
            dialogue_id = self.system.create_dialogue(
                agent1_id, agent2_id, topic, dialogue_type
            )
