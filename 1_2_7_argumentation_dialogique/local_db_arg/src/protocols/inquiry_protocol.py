...
class InquiryProtocol(DialogueProtocol):
    ...
    def _setup_protocol(self):
        self.allowed_transitions = {
            SpeechAct.QUESTION: [SpeechAct.CLAIM, SpeechAct.ARGUE, SpeechAct.QUESTION, SpeechAct.SUPPORT],
            SpeechAct.CLAIM: [SpeechAct.SUPPORT, SpeechAct.CHALLENGE, SpeechAct.QUESTION, SpeechAct.UNDERSTAND],
            SpeechAct.SUPPORT: [SpeechAct.QUESTION, SpeechAct.UNDERSTAND, SpeechAct.CHALLENGE],
            SpeechAct.CHALLENGE: [SpeechAct.ARGUE, SpeechAct.SUPPORT, SpeechAct.QUESTION],
            SpeechAct.ARGUE: [SpeechAct.CHALLENGE, SpeechAct.UNDERSTAND, SpeechAct.QUESTION, SpeechAct.SUPPORT],
            SpeechAct.UNDERSTAND: [SpeechAct.QUESTION, SpeechAct.UNDERSTAND, SpeechAct.CLAIM],
        ...
        self.termination_conditions = [
            ...
            lambda h: len(h) >= 3 and all(m.act in [SpeechAct.UNDERSTAND, SpeechAct.CONCEDE] for m in h[-3:]),
            # Limite de longueur
            lambda h: len(h) > 25,
