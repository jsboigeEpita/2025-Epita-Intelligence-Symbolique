...
class PersuasionProtocol(DialogueProtocol):
    ...
    def _setup_protocol(self):
        self.allowed_transitions = {
            SpeechAct.CLAIM: [SpeechAct.CHALLENGE, SpeechAct.CONCEDE, SpeechAct.QUESTION, SpeechAct.SUPPORT],
            SpeechAct.CHALLENGE: [SpeechAct.ARGUE, SpeechAct.RETRACT, SpeechAct.SUPPORT],
            SpeechAct.ARGUE: [SpeechAct.CHALLENGE, SpeechAct.CONCEDE, SpeechAct.REFUTE, SpeechAct.SUPPORT],
            ...
            SpeechAct.SUPPORT: [SpeechAct.UNDERSTAND, SpeechAct.CHALLENGE, SpeechAct.QUESTION],
