...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers",
        "requires_openai: marks tests requiring OPENAI_API_KEY"
    )
    config.addinivalue_line(
        "markers",
        "requires_github: marks tests requiring GITHUB_TOKEN"
    )
    config.addinivalue_line(
        "markers",
        "requires_openrouter: marks tests requiring OPENROUTER_API_KEY"
    )
