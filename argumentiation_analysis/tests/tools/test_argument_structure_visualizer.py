...
class TestArgumentStructureVisualizer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.matplotlib_patcher = patch('argumentiation_analysis.agents.tools.analysis.new.argument_structure_visualizer.plt')
        self.matplotlib_mock = self.matplotlib_patcher.start()
        
        self.networkx_patcher = patch('argumentiation_analysis.agents.tools.analysis.new.argument_structure_visualizer.nx')
