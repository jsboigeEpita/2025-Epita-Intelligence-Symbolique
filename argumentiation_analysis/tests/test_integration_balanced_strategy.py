...
class TestBalancedStrategyIntegration(AsyncTestCase):
    ...
    async def test_balanced_strategy_integration(self):
        ...
        # Premier tour - devrait sélectionner le PM (agent par défaut)
        ...
        # Deuxième tour - devrait sélectionner un autre agent pour équilibrer
        selected_agent = await balanced_strategy.next(self.agents, history)
        self.assertNotEqual(selected_agent, self.pm_agent)
        
        # Ajouter un message de l'agent sélectionné à l'historique
    ...
    async def test_balanced_strategy_with_designations(self):
        ...
        # Premier tour - désigner explicitement l'agent PL
        ...
        # Deuxième tour - désigner explicitement l'agent informel
        ...
        # Troisième tour - sans désignation, devrait équilibrer
        selected_agent = await balanced_strategy.next(self.agents, history)
        ...
        # Vérifier que le budget de déséquilibre a été ajusté
    ...
    async def test_balanced_strategy_in_group_chat(self):
        ...
        # Troisième tour - devrait sélectionner un autre agent pour équilibrer
...
class TestBalancedStrategyEndToEnd(AsyncTestCase):
    ...
    @patch('orchestration.analysis_runner.BalancedParticipationStrategy')
    ...
    async def test_balanced_strategy_in_analysis_runner(self, mock_agent_group_chat, mock_balanced_strategy):
        ...
        # Appeler la fonction à tester avec les mocks appropriés
        with patch('orchestration.analysis_runner.RhetoricalAnalysisState'), \
             ...
             patch('orchestration.analysis_runner.setup_extract_agent', return_value=(mock_extract_kernel, mock_extract_agent)), \
        ...
        # Vérifier que la stratégie d'équilibrage a été utilisée
