...
# Créer le module argumentiation_analysis s'il n'existe pas déjà
if 'argumentiation_analysis' not in sys.modules:
    argumentiation_analysis_module = types.ModuleType('argumentiation_analysis')
    sys.modules['argumentiation_analysis'] = argumentiation_analysis_module
else:
    argumentiation_analysis_module = sys.modules['argumentiation_analysis']

# Créer le module orchestration
orchestration_module = types.ModuleType('argumentiation_analysis.orchestration')
sys.modules['argumentiation_analysis.orchestration'] = orchestration_module
setattr(argumentiation_analysis_module, 'orchestration', orchestration_module)

# Créer le module analysis_runner
analysis_runner_module = types.ModuleType('argumentiation_analysis.orchestration.analysis_runner')
sys.modules['argumentiation_analysis.orchestration.analysis_runner'] = analysis_runner_module
...
scripts_module = types.ModuleType('argumentiation_analysis.scripts')
sys.modules['argumentiation_analysis.scripts'] = scripts_module
setattr(argumentiation_analysis_module, 'scripts', scripts_module)

# Créer le module verify_extracts
verify_extracts_module = types.ModuleType('argumentiation_analysis.scripts.verify_extracts')
sys.modules['argumentiation_analysis.scripts.verify_extracts'] = verify_extracts_module
...
models_module = types.ModuleType('argumentiation_analysis.models')
sys.modules['argumentiation_analysis.models'] = models_module
setattr(argumentiation_analysis_module, 'models', models_module)

# Créer le module extract_definition
extract_definition_module = types.ModuleType('argumentiation_analysis.models.extract_definition')
sys.modules['argumentiation_analysis.models.extract_definition'] = extract_definition_module
...
extract_result_module = types.ModuleType('argumentiation_analysis.models.extract_result')
sys.modules['argumentiation_analysis.models.extract_result'] = extract_result_module
...
services_module = types.ModuleType('argumentiation_analysis.services')
sys.modules['argumentiation_analysis.services'] = services_module
setattr(argumentiation_analysis_module, 'services', services_module)

# Créer le module extract_service
extract_service_module = types.ModuleType('argumentiation_analysis.services.extract_service')
sys.modules['argumentiation_analysis.services.extract_service'] = extract_service_module
...
fetch_service_module = types.ModuleType('argumentiation_analysis.services.fetch_service')
sys.modules['argumentiation_analysis.services.fetch_service'] = fetch_service_module
