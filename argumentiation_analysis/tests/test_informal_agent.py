...
from agents.informal.informal_definitions import InformalAnalysisPlugin, setup_informal_kernel
...
class TestInformalAnalysisPlugin(unittest.TestCase):
    ...
    @patch('agents.informal.informal_definitions.pd.read_csv')
    @patch('agents.informal.informal_definitions.requests.get')
...
class TestSetupInformalKernel(AsyncTestCase):
    ...
    @patch('agents.informal.informal_definitions.prompt_identify_args_v8')
    @patch('agents.informal.informal_definitions.prompt_analyze_fallacies_v1')
    @patch('agents.informal.informal_definitions.prompt_justify_fallacy_attribution_v1')
