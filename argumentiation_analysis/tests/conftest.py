...
# Créer un module factice pour argumentiation_analysis
argumentiation_analysis = types.ModuleType('argumentiation_analysis')
sys.modules['argumentiation_analysis'] = argumentiation_analysis

# Créer des sous-modules
argumentiation_analysis.models = types.ModuleType('argumentiation_analysis.models')
argumentiation_analysis.services = types.ModuleType('argumentiation_analysis.services')
sys.modules['argumentiation_analysis.models'] = argumentiation_analysis.models
sys.modules['argumentiation_analysis.services'] = argumentiation_analysis.services
...
argumentiation_analysis.models.extract_definition = models.extract_definition
argumentiation_analysis.models.extract_result = models.extract_result
argumentiation_analysis.services.cache_service = services.cache_service
argumentiation_analysis.services.crypto_service = services.crypto_service
argumentiation_analysis.services.definition_service = services.definition_service
argumentiation_analysis.services.extract_service = services.extract_service
argumentiation_analysis.services.fetch_service = services.fetch_service
