...
try:
    ...
    try:
        ...
        CONFIG_FILE = "C:/dev/2025-Epita-Intelligence-Symbolique/argumentiation_analysis/data/extract_sources.json.gz.enc"
...
async def main():
    ...
    if not os.path.exists(input_file) and not os.path.exists(CONFIG_FILE_JSON):
