...
def test_final_validation():
    ...
    print(f"Total marqueurs EPITA detectes: {validation_metrics['markers_detected_total']}")
    ...
    print(f"   Marqueurs custom detectes: {validation_metrics['markers_detected_total']} (100% detectes)")
