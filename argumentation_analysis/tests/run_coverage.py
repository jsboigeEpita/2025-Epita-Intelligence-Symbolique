...
def analyze_coverage_by_module(coverage_data_path):
    ...
    try:
        ...
        for file_path, file_data in coverage_data.get("files", {}).items():
            ...
            if "argumentation_analysis" in path_parts:
                idx = path_parts.index("argumentation_analysis")
...
def run_tests_with_coverage():
    ...
    pytest_args = [
        "-v",  # Mode verbeux
        "--cov=argumentation_analysis",  # Mesurer la couverture pour tout le package
