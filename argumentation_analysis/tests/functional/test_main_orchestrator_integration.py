...
MAIN_ORCHESTRATOR_PATH = PROJECT_ROOT / "argumentation_analysis" / "main_orchestrator.py"
...
def test_hierarchical_orchestration(sample_text_file):
    ...
    assert json_output is not None, "Aucun bloc JSON valide et complet n'a été trouvé dans stdout."
