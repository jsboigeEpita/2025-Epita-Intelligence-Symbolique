...
class TestComplexFallacyAnalyzer(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.analyzer.contextual_analyzer, self.mock_contextual_analyzer)
    ...
    def test_load_fallacy_combinations(self):
        ...
        self.assertIn("Attaque personnelle généralisée", self.analyzer.fallacy_combinations)
    ...
    def test_identify_combined_fallacies_with_matches(self):
        ...
        self.assertGreater(result[0]["severity"], 0.8)  # Devrait être 0.8 + 0.2 = 1.0 (plafonné)
    ...
    def test_analyze_structural_fallacies(self):
        ...
        with patch.object(self.analyzer, '_detect_contradictions') as mock_detect_contradictions, \
            ...
            # Vérifier les résultats
            self.assertEqual(len(result), 1)
            self.assertEqual(result[0]["structural_fallacy_type"], "Contradiction cachée")
    ...
    def test_identify_fallacy_patterns(self):
        ...
        # Patch pour les méthodes internes
        with patch.object(self.analyzer, '_detect_alternation_patterns') as mock_detect_alternation, \
            ...
            self.assertEqual(result[0]["fallacy_types"], ["Appel à l'autorité", "Appel à l'émotion"])
    ...
    def test_detect_alternation_patterns(self):
        ...
        paragraph_fallacies = [
            ...
            },
            {
                "paragraph_index": 1,
                "fallacies": [
                    {"fallacy_type": "Appel à l'émotion", "confidence": 0.7}
                ]
            },
            {
                "paragraph_index": 2,
    ...
    def test_detect_escalation_patterns(self):
        ...
        self.assertEqual(result[0]["fallacy_sequence"], ["Appel à la tradition", "Appel à l'autorité", "Ad hominem"])
