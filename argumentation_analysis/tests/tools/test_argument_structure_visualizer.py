...
class TestArgumentStructureVisualizer(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertIsNotNone(self.visualizer.visualization_history) # Corrigé: visualization_options -> visualization_history
    ...
    def test_visualize_argument_structure(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = self.visualizer.visualize_argument_structure(
                ...
                self.test_context,
                "json",
                output_path=str(output_dir) # Corrigé: output_dir -> output_path
            )
    ...
    #     # structure = self.visualizer._analyze_argument_structure(self.test_arguments, self.test_context) # Appel à une méthode privée
    ...
    #     # roles = self.visualizer._identify_argument_roles(self.test_arguments) # Appel à une méthode privée
    ...
    #     # relationships = self.visualizer._infer_argument_relationships(self.test_arguments) # Appel à une méthode privée
    ...
    #     # structure_type = self.visualizer._determine_structure_type(relationships, len(self.test_arguments)) # Appel à une méthode privée
    ...
    #     #     # Appeler la méthode avec le répertoire temporaire
    #     #     visualization_files = self.visualizer._create_graph_visualization( # Appel à une méthode privée
    ...
    #     #     # Appeler la méthode avec le répertoire temporaire
    #     #     visualization_data, visualization_files = self.visualizer._create_json_visualization( # Appel à une méthode privée
    #     #         structure, self.test_arguments, output_dir
    #     #     )
    ...
    #     #     # Appeler la méthode avec le répertoire temporaire
    #     #     visualization_data, visualization_files = self.visualizer._create_html_visualization( # Appel à une méthode privée
    #     #         structure, self.test_arguments, output_dir
    #     #     )
    ...
    #     # summary = self.visualizer._generate_text_summary(structure, self.test_arguments) # Appel à une méthode privée
