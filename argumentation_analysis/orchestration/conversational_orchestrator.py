...
AGENT_CONFIG = {
    ...
    "FormalAgent": {
        ...
        "instructions": (
            ...
            "RAISONNEMENT : FOL est la logique par defaut car elle capture les "
            "relations et predicats entre entites (qui a fait quoi, qui croit quoi) "
            "que la logique propositionnelle ne peut pas exprimer — un argument "
            "politique reliant un acteur a une action est une relation, pas un atome "
            "booleen. PL n'intervient qu'en fallback quand l'argument est purement "
            "propositionnel ou que FOL echoue.\n"
