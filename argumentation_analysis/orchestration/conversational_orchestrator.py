...
AGENT_CONFIG = {
    ...
    "ExtractAgent": {
        ...
        "instructions": (
            ...
            "ETAPE 1 — EXTRACTION DES ARGUMENTS (OBLIGATOIRE EN PREMIER) :\n"
            "1. Analyse le texte pour identifier les arguments, premisses et conclusions\n"
            "2. Pour CHAQUE argument identifie, appelle add_identified_argument(description) "
            "avec une description detaillee incluant les premisses et la conclusion\n"
            "3. Objectif minimum : 3 arguments sur un texte de >5000 mots, 5+ sur >20000 mots\n"
            "4. Identifie les relations entre arguments (support, attaque)\n"
            "5. NE PAS utiliser add_jtms_belief ou jtms_create_belief AVANT d'avoir "
            "termine l'extraction complete avec add_identified_argument pour TOUS les arguments\n\n"
            "ETAPE 2 — JTMS (UNIQUEMENT APRES ETAPE 1 COMPLETE) :\n"
            "Pour chaque argument extrait a l'etape 1, cree une croyance JTMS :\n"
    ...
    "InformalAgent": {
        ...
        "instructions": (
            ...
            "OBJECTIF QUANTITATIF (#595) : Sur un texte de >10000 mots, tu DOIS detecter "
            "au minimum 5 sophismes couvrant au moins 3 des 7 familles de la taxonomie :\n"
            "1. Appel a l'autorite / Popularite / Emotion\n"
            "2. Attaque personnelle (Ad hominem, Tu quoque)\n"
            "3. Pente glissante / Faux dilemme\n"
            "4. Homme de paille / Red herring\n"
            "5. Petition de principe / Generalisation hative\n"
            "6. Non sequitur / Post hoc / Fausse equivalence\n"
            "7. Appel a l'ignorance / Cherry picking\n\n"
            "Si apres run_guided_analysis tu as moins de 3 sophismes, relance avec detect_fallacies() "
            "comme FALLBACK SYSTEMATIQUE — ne pas rendre un resultat vide.\n"
            "Si aucun argument n'est identifie, analyse le texte brut directement.\n\n"
