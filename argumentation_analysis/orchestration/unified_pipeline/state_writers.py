"""State writer functions for pipeline phase outputs.

Each writer: (output, state, ctx) -> None
Writes phase output data into the appropriate UnifiedAnalysisState fields.
"""
import logging
