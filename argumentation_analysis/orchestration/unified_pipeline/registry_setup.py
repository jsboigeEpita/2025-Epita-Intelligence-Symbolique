"""Registry setup and Tweety slot declarations.

Registers all available components (agents, services, adapters) into
the CapabilityRegistry, including invoke callables and state writers.
"""
import logging
...
from argumentation_analysis.orchestration.unified_pipeline._helpers import logger
