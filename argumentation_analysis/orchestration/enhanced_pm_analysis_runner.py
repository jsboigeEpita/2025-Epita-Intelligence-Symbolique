...
class EnhancedProjectManagerOrchestrator:
    ...
    def __init__(self, llm_service: Union[OpenAIChatCompletion, AzureChatCompletion]):
        ...
        warnings.warn(
            "`EnhancedProjectManagerOrchestrator` is deprecated and will be removed in a future version. "
...
async def run_enhanced_pm_orchestration_demo(
    ...
    """
    warnings.warn(
        "`run_enhanced_pm_orchestration_demo` is deprecated and part of a legacy module. "
        "It is maintained for backward compatibility only. "
        "Please use the new agent group chat architecture for new implementations.",
        DeprecationWarning,
        stacklevel=2,
