...
def main():
    ...
    try:
        from argumentation_analysis.ui.extract_editor.extract_marker_editor import (
            main as editor_main,
        )
        ...
        print(
            "Vérifiez que le fichier extract_marker_editor.py est présent dans le répertoire ui/extract_editor/."
        )
        raise
