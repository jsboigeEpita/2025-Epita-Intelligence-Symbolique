...
"""
import logging
from pathlib import Path # Gardé pour type hinting si nécessaire, ou si des fonctions y restent
from typing import List, Dict, Any, Optional, Union, Tuple # Gardé pour exposition potentielle ou type hinting
...
if not logger.handlers and not logger.propagate: # Configuration de base si pas déjà configuré
...
logger.info("Module principal des utilitaires de fichiers (file_utils.py) initialisé et sous-modules importés.")