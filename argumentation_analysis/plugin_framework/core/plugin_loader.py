            ...
            for item in os.listdir(path):
                ...
                if os.path.isdir(item_path):
                    ...
                    try:
                        ...
                        for _, class_member in inspect.getmembers(
                            module, inspect.isclass
                        ):
                            # Vérifie si la classe est bien définie dans ce module,
                            # hérite de BasePlugin, et n'est pas BasePlugin elle-même.
                            if (
                                class_member.__module__ == module_name
                                and issubclass(class_member, BasePlugin)
                                and class_member is not BasePlugin
                            ):
                        ...
                        print(
                            f"Avertissement : Impossible d'importer le module {module_name}. Erreur: {e}"
                        )
