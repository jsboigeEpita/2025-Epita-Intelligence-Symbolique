...
class ProjectManagerAgent(BaseAgent):
    ...
    def __init__(self, kernel: Kernel, agent_name: str = "ProjectManagerAgent", instructions: Optional[str] = PM_INSTRUCTIONS):
        super().__init__(kernel=kernel, agent_name=agent_name, system_prompt=instructions)
        self.kernel = kernel
        self.instructions = instructions
        logging.getLogger(__name__).info(f"ProjectManagerAgent '{agent_name}' initialisé.")
