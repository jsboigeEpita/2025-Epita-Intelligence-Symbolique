...
=======
from semantic_kernel.contents import ChatMessageContent #, AuthorRole # Potentiellement plus nécessaire directement # Temporairement commenté
>>>>>>> feature/migrate-project-core
