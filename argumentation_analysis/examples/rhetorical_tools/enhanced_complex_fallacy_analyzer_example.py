...
import asyncio
from argumentation_analysis.tools.enhanced_complex_fallacy_analyzer import (
...
async def run_complex_fallacy_analysis():
    ...
    logger.info(
        f"Répartition des sophismes: {json.dumps(results['fallacy_distribution'], indent=2)}"
    )
