...
def main():
    ...
    def tactical_agent():
        ...
        while directives_received < 2:
            ...
            if directive:
                ...
                print(
                    f"Envoi d'un rapport de progression pour la directive {directives_received}..."
                )
                ...
                print(
                    f"Envoi d'un rapport final pour la directive {directives_received}..."
                )
                tactical_adapter.send_report(
    ...
    def strategic_agent():
        ...
        for directive in tactical_directives:
            print(
                f"Émission de la directive pour l'objectif {directive['objective_id']}..."
            )
        ...
        while final_reports_received < 2:
            ...
            if report:
                ...
                if "objective_progress" in strategic_info:
                    for obj_id, progress in strategic_info[
                        "objective_progress"
                    ].items():
