...
def main():
    ...
    middleware.add_content_routing_rule(
        "content.request_type", "collaboration", "collaboration"
    )
    ...
    def tactical_agent1():
        ...
        while results_received < 2:
            ...
            message = tactical_adapter1.receive_message(
                timeout=10.0, filter_criteria={"content.info_type": "task_result"}
            )
        ...
        combined_result = {
            "structure_globale": {"type": "argument_complexe", "nombre_arguments": 3},
    ...
    def tactical_agent2():
        ...
        message = tactical_adapter2.receive_message(
            timeout=5.0, filter_criteria={"content.info_type": "task_allocation"}
        )
        ...
        combined_result = tactical_adapter2.receive_message(
            timeout=10.0, filter_criteria={"content.info_type": "combined_result"}
        )
