...
def ensure_env(env_name: str = None, silent: bool = False) -> bool:
    ...
    if env_name is None:
        try:
            ...
            env_name = settings.model_dump().get('CONDA_ENV_NAME', os.environ.get('CONDA_ENV_NAME', 'projet-is-roo-new'))
        except (ImportError, AttributeError):
            env_name = os.environ.get('CONDA_ENV_NAME', 'projet-is-roo-new')
