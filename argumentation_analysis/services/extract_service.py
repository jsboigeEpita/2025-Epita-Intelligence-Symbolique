    ...
    def extract_text_with_markers(
        ...
        if start_marker:
            try:
                ...
                start_index = found_start # Inclure le marqueur de début
                start_found = True
            except ValueError:
                ...
                if template_start:
                    try:
                        ...
                        start_index = found_start # Inclure le marqueur de début avec template
                        start_found = True
                    except ValueError:
                        pass
        ...
        if end_marker:
            try:
                ...
                end_index = found_end + len(end_marker) # Inclure le marqueur de fin
                end_found = True
            except ValueError:
                pass
