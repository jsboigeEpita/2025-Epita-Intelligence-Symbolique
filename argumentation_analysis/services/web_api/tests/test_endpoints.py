...
class TestAnalyzeEndpoint:
    ...
    def test_analyze_success(
        self, client, mock_analysis_service, sample_analysis_request
    ):
        ...
        assert (
            data["text_analyzed"] == sample_analysis_request["text"]
        )  # Vérifier le texte de la requête
    ...
    def test_analyze_integration_simple_success(
        self, client, sample_analysis_request, mock_analysis_service
    ):  # Ajout de mock_analysis_service
    ...
    def test_analyze_missing_body(self, client):
        ...
        )  # S'attendre à 415 car request.get_json() échoue sans Content-Type
        data = response.get_json()
        assert (
            data["error"] == "Unsupported Media Type"
        )  # Message d'erreur de HTTPException
        assert (
    ...
    def test_analyze_invalid_options(self, client):
        ...
        request_data = {
            "text": "Texte valide",
            "options": {"severity_threshold": 2.0},  # Valeur invalide (> 1.0)
        }
...
class TestValidateEndpoint:
    ...
    def test_validate_success(
        self, client, mock_validation_service, sample_validation_request
    ):
    ...
    def test_validate_missing_premises(self, client):
        ...
        request_data = {"conclusion": "Conclusion", "argument_type": "deductive"}
...
class TestFallaciesEndpoint:
    ...
    def test_detect_fallacies_success(
        self, client, mock_fallacy_service, sample_fallacy_request
    ):
    ...
    def test_detect_fallacies_invalid_threshold(self, client):
        ...
        request_data = {
            "text": "Texte valide",
            "options": {"severity_threshold": -0.5},  # Valeur invalide
        }
...
class TestFrameworkEndpoint:
    ...
    def test_build_framework_success(
        self, client, mock_framework_service, sample_framework_request
    ):
    ...
    def test_build_framework_empty_arguments(self, client):
        ...
        request_data = {"arguments": [], "options": {}}
    ...
    def test_build_framework_invalid_semantics(self, client):
        ...
        request_data = {
            "arguments": [{"id": "arg1", "content": "Argument 1"}],
            "options": {"semantics": "invalid_semantics"},
        }
...
class TestErrorHandling:
    ...
    def test_malformed_json(self, client):
        ...
        response = client.post(
            "/api/analyze", data='{"invalid": json}', content_type="application/json"
        )
    ...
    def test_missing_content_type(self, client):
        ...
        response = client.post("/api/analyze", data='{"text": "test"}')
