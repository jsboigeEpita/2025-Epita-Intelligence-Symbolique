...
FALLACY_FAMILY_METRICS = {
    ...
    FallacyFamily.DIVERSION_ATTACK: {
        ...
        "diversion_degree": {"description": "Degré de diversion (0-1)", "weight": 0.3},
        "discussion_impact": {
    ...
    FallacyFamily.LANGUAGE_AMBIGUITY: {
        "ambiguity_degree": {"description": "Degré d'ambiguïté (0-1)", "weight": 0.4},
    ...
    FallacyFamily.AUDIO_ORAL_CONTEXT: {
        ...
        "speech_rate": {"description": "Débit de parole (mots/minute)", "weight": 0.4},
    },
}
