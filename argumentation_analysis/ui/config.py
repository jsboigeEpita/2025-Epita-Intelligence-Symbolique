...
)  # ui -> argumentation_analysis -> racine
...
try:
    ...
    config_logger.info(
        f"Répertoires de compatibilité assurés: {TEMP_DOWNLOAD_DIR}, {CACHE_DIR}, {CONFIG_DIR}"
    )
except Exception as e:
    config_logger.error(f"Erreur création répertoires de compatibilité: {e}")

config_logger.info(
    "Module de configuration UI (obsolète) initialisé en mode compatibilité."
)
