...
class AdvancedDungAgentTests(unittest.TestCase):
    ...
    def test_cardinality_bounds(self):
        ...
        for ext in preferred:
            ...
            self.assertTrue(isolated_args.issubset(ext_set),
            ...
            self.assertEqual(len(pair_intersection), 1,
