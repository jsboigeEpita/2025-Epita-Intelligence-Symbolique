...
powershell -File ./activate_project_env.ps1 -CommandToRun "pytest tests/unit/argumentation_analysis/services/test_mcp_server.py tests/integration/services/test_mcp_server_integration.py"