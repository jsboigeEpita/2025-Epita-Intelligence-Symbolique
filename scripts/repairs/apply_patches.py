...
def apply_patch(patch_file_path):
    ...
    try:
        ...
        print("Changes may have been saved to a .rej file. Manual review needed.", file=sys.stderr)
        return False
...
def main():
    ...
    if fail_count > 0:
        print(f"Failed to apply {fail_count} patches cleanly. Please check for .rej files and review the logs.")
