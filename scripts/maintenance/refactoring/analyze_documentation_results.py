...
def main():
    ...
    print(f"   🤖 Corrections automatiques: {correction_plan['summary']['auto_correctable']}")
    print(f"   👁️ Révision manuelle requise: {correction_plan['summary']['manual_review_needed']}")
