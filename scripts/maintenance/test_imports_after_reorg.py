...
import argumentation_analysis.core.environment  # bootstrap racine du dépôt
...
def run_tests():
    ...
    if all_passed:
        ...
        print(
            "Note: Ces problèmes peuvent être liés à des dépendances manquantes et non à la réorganisation des fichiers."
        )
