...
def update_imports():
    ...
    print(
        "  ⚠ Vous devrez peut-être ajuster manuellement les imports dans les scripts déplacés"
    )
...
def create_main_readme():
    ...
    print("  ⚠ Cette fonctionnalité n'est pas implémentée dans cette version")
    print(
        "  ⚠ Vous devrez mettre à jour manuellement le README.md pour refléter la nouvelle structure"
    )
...
def main():
    ...
    print(
        "1. Vérifier que les scripts fonctionnent correctement dans leur nouvel emplacement"
    )
