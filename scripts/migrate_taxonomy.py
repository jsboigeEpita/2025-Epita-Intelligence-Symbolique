...
if __name__ == "__main__":
    ...
    CSV_PATH = os.path.join(BASE_DIR, 'argumentation_analysis', 'data', 'taxonomy_full.csv')
    JSON_PATH = os.path.join(BASE_DIR, 'argumentation_analysis', 'data', 'taxonomy_full.json')
