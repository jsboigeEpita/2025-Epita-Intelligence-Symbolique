...
if not OPENAI_API_KEY:
    ...
    # OPENAI_API_KEY = "sk-..."  
    raise RuntimeError("OPENAI_API_KEY environment variable is not set. Please set it before running.")
...
def gpt_llm_fn(input_text: str) -> str:
    ...
    response = openai.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": "Réponds uniquement par un score numérique entre 0 et 1, sans explication."},
