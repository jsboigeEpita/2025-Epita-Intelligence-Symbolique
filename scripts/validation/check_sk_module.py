...
try:
    ...
    print(
        "SUCCESS: `FunctionInvokingEventArgs` successfully imported from `semantic_kernel.events`."
    )
    ...
    print(
        "This often indicates a PYTHONPATH issue, where a local folder named 'semantic_kernel' is shadowing the installed package."
    )
    ...
    print(
        "This might mean the `semantic-kernel` package is not correctly installed or there is a version mismatch."
    )
