...
class MigrationValidator:
    ...
    def validate_legacy_archival(self) -> bool:
        ...
        if old_script.exists():
            ...
            self.log("Script PowerShell introuvable (ni à la racine ni dans les archives)", "WARNING")
            success = False
    ...
    def run_validation(self) -> Dict:
        ...
        # Affichage du résumé
        self.log("\n" + "=" * 60, "INFO")
        self.log(f"RÉSULTAT GLOBAL: {overall_status}", "SUCCESS" if success_rate >= 0.8 else "ERROR")
...
def main():
    ...
    # Code de sortie
    exit_code = 0 if results['overall_status'] in ["RÉUSSI", "RÉUSSI_AVEC_AVERTISSEMENTS"] else 1
    sys.exit(exit_code)
