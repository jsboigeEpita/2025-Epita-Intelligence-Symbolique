...
async def validate_integration(
    report_errors_list: list, available_components: Dict[str, bool], test_texts: list
) -> Dict[str, Any]:
    ...
    try:
        ...
        if available_components.get(
            ...
            integration_results["handoff_tests"] = {
                "status": "skipped",
                "reason": "Orchestrateurs requis non disponibles",
            }
        ...
        if available_components.get("unified_config", False):
            ...
            integration_results["config_mapping"] = {
                "status": "skipped",
                "reason": "Config unifiée non disponible",
            }
...
async def _test_config_mapping() -> Dict[str, Any]:
    ...
    try:
        ...
        results["error"] = str(e)
        logger.error(
            f"    ✗ Erreur générale durant le test de mapping de configuration: {e}",
            exc_info=True,
        )
