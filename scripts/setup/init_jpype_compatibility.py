...
def init_compatibility():
    ...
    if sys.version_info.major == 3 and sys.version_info.minor >= 12:
        logger.info(
            "Python 3.12 ou supérieur détecté, utilisation du module mock JPype1"
        )
        try:
        ...
        logger.info(
            f"Python {sys.version_info.major}.{sys.version_info.minor} détecté, utilisation de JPype1 standard"
        )
        return True
