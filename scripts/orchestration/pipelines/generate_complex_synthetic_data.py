...
class ComplexSyntheticDataGenerator:
    ...
    def __init__(self):
        self.themes = [
            ...
            "le libre arbitre à l'ère numérique",
        ]
    ...
    def generate_single_scenario(
        self, complexity: str, scenario_id: int
    ) -> Dict[str, Any]:
        ...
        philosophical_argumentation = {
            ...
            "levels": {
                "niveau_1_these": {
                    "texte": f"La these principale est que {theme} est une inevitabilite technologique."
                },
                "niveau_2_antithese": {
                    "texte": f"L'antithese, selon {philosophe}, est que cela detruit l'autonomie humaine."
                },
                "niveau_3_sophisme": {
                    "texte": "Dire que l'opposition à cette technologie vient de la peur du progrès est un sophisme.",
                    "sophismes_imbriques": [
                        {"type": sophisme_type, "texte": self.sophismes[sophisme_type]}
                    ],
                },
            },
        }
        ...
        scenario = {
            ...
            "metadata": {
                ...
                "complexity_signature": hashlib.sha256(
                    f"{theme}{philosophe}{scenario_id}".encode()
                ).hexdigest(),
            ...
            "arguments": [
                {
                    "id": "arg1",
                    "type": "these",
                    "content": philosophical_argumentation["levels"]["niveau_1_these"][
                        "texte"
                    ],
                },
                {
                    "id": "arg2",
                    "type": "antithese",
                    "content": philosophical_argumentation["levels"][
                        "niveau_2_antithese"
                    ]["texte"],
                },
            ],
    ...
    def generate_multiple_scenarios(
        self, complexity: str = "high", num_scenarios: int = 1
    ) -> List[Dict[str, Any]]:
        """Génère plusieurs scénarios de test complexes."""
        return [
            self.generate_single_scenario(complexity, i) for i in range(num_scenarios)
        ]
...
if __name__ == "__main__":
    ...
    scenarios = generator.generate_multiple_scenarios(
        complexity="high", num_scenarios=1
    )
