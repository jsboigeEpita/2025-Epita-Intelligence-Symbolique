#!/usr/bin/env python3
"""Helper script to write the C-05 audit report."""
import os

content = """# C-05: Audit Sujets — Section II-C Moteur Agentique et Agents Spécialistes
...
path = os.path.join('docs', 'reports', 'subjects_audit', 'C-05_moteur_agentique.md')
