...
def main():
    ...
    files_to_delete = ['analyze_phase2_by_groups.py', 'auto_logical_analysis_task1_fixed.py', 'auto_logical_analysis_task1_VRAI.py', 'batch_test_analysis.py', 'diagnostic_tests_phases.py', 'diagnostic_tests_unitaires.py', 'final_system_integration_test.py', 'fix_asyncio_decorators.py', 'fix_critical_imports.py', 'fix_return_assert.py', 'fix_unicode_conda.py', 'get_env_name.py', 'localize_source_contents.py', 'measure_final_success_rate.py', 'migrate_to_service_manager.py', 'minimal_test_diagnostic.py', 'phase4_final_validation.py', 'populate_extract_segments.py', 'rapport_investigation_tests_unitaires.py', 'test_jpype_killer.py', 'test_orchestration_scenario.py', 'test_practical_capabilities.py', 'test_unicode_encoding.py', 'validate_new_components_tests.py', 'validate_unified_system.py', 'validation_point4_rhetorical_analysis.py', 'validation_point5_final_comprehensive.py', 'validation_point5_realistic_final.py']
