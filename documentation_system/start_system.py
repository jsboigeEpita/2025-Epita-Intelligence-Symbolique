...
class DocumentationSystemStarter:
    ...
    def run_analysis(self) -> bool:
        ...
        try:
            ...
            print(f" Analyse terminée : {analysis['metadata']['total_modules_analyzed']} modules")
            return True
    ...
    def run_interactive_interface(self, mode: str = "auto") -> bool:
        ...
        try:
            ...
            guide = InteractiveDocumentationGuide(
                self.output_files['analysis'],
                self.output_files['knowledge']
            )
...
Exemples d'utilisation :
  ...
  python start_system.py --project ../     # Projet dans dossier parent
    ...
    # Workflow complet
    success = starter.run_complete_workflow(
        mode=args.mode,
        clean=args.clean
    )
