---
restored_from_sha: e016e59b
original_authored_date: 2025-06-06
original_path: argumentation_analysis/docs/DESIGN_INFERENCE_REPAIR.md
...
> **Note**: This document was deleted by commit `48f514c5` (chore(cleanup): remove dead directories from argumentation_analysis/ #442). It describes the inference chain repair design — load-bearing context for fallacy workflow work in issue #578. Restored from git history.
