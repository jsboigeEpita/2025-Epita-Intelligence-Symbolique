...
original_path: docs/refactoring/04_scripts_maintenance_consolidation_plan.md
...
> **Note**: This document was deleted by commit `c7ba0e3a` (chore(#130): TIER 2 — consolidate docs/ structure). It is the scripts maintenance consolidation plan — load-bearing reference for scripts infrastructure decisions. Restored from git history.
