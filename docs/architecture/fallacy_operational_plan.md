...
original_authored_date: 2025-07-16
original_path: docs/refactoring/informal_fallacy_system/04_operational_plan.md
...
> **Note**: This document was deleted by commit `c7ba0e3a` (chore(#130): TIER 2 — consolidate docs/ structure). It is the operational plan for the informal fallacy system refactoring — load-bearing reference for active fallacy pipeline work. Restored from git history.
