---
restored_from_sha: f6cf8c41
original_authored_date: 2025-06-29
original_path: argumentation_analysis/docs/architecture_fallacy_workflows.md
deleted_by_sha: 48f514c5
deleted_in_pr: 442
...
> **Note**: This document was deleted by commit `48f514c5` (chore(cleanup): remove dead directories from argumentation_analysis/ #442). It describes the FallacyWorkflowPlugin architecture — load-bearing context for active work in issue #578. Restored from git history.
