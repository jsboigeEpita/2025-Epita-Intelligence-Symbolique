...
original_path: docs/maintenance/LLM_SERVICE_API_COMPATIBILITY_FIX.md
...
> **Note**: This document was deleted by commit `a62ef234` (chore(#130): TIER 2 continued — remove obsolete maintenance and validation docs). It documents the SK API compatibility fix for LLM services — load-bearing reference for API integration. Restored from git history.
