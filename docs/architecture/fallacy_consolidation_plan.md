...
original_path: docs/refactoring/informal_fallacy_system/03_informal_fallacy_consolidation_plan.md
...
> **Note**: This document was deleted by commit `c7ba0e3a` (chore(#130): TIER 2 — consolidate docs/ structure). It is the consolidation plan for the informal fallacy system — load-bearing reference for active fallacy pipeline work. Restored from git history.
