...
original_authored_date: 2025-06-27
original_path: docs/refactoring/informal_fallacy_system/01_informal_fallacy_system_analysis.md
...
> **Note**: This document was deleted by commit `c7ba0e3a` (chore(#130): TIER 2 — consolidate docs/ structure). It is the analysis document for the informal fallacy system — load-bearing reference for understanding current architecture. Restored from git history.
