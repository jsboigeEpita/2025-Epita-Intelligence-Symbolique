...
<!--
Provenance header (Cleanup Gate compliance):
- Original date: 2025-07-16
- Deleted by: PR #130 (Cleanup Gate incident — design docs mistaken for drafts)
- Restored from: git show 5f0422b8:DESIGN_PARALLEL_WORKFLOW.md
- Restored under: Epic #1045 / RA-3 #1048 (Agentic Redressement)
- Restoration date: 2026-06-11
- Status: Accurate — the parallel exploration architecture (asyncio.gather over
  branches, result aggregation, synthesis) is implemented in
  argumentation_analysis/plugins/fallacy_workflow_plugin.py. This doc remains
  the canonical design reference for the MapReduce-style parallel descent.
-->
