# Archived: 2026-03-24 - Superseded by argumentation_analysis/agents/factory.py
# Issue: #213 (consolidate duplicate factories and base_agent files)
# Features merged: create_agent(), _create_informal_fallacy_agent(), _create_project_manager_agent()
#
# All functionality (and more) exists in:
#   - argumentation_analysis/agents/factory.py (AgentFactory with 7+ create methods)
# Migration:
#   - Replace AgentFactory(config={...}) with AgentFactory(kernel, llm_service_id)
#   - Replace create_agent("informal") with create_agent(AgentType.INFORMAL_FALLACY)

"""
Agent Factory Module (ARCHIVED — use agents/factory.py instead)
