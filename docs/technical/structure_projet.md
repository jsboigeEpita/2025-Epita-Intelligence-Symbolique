...
Des utilitaires de normalisation de texte sont disponibles dans [`argumentation_analysis/core/utils/text_utils.py`](../../argumentation_analysis/core/utils/text_utils.py:1). Ces fonctions permettent :
...
La fonction principale pour ces opérations est `normalize_text(text: str)` ([`../../argumentation_analysis/core/utils/text_utils.py:17`](../../argumentation_analysis/core/utils/text_utils.py:17)).
...
*   La fonction `tokenize_text(text: str)` ([`../../argumentation_analysis/core/utils/text_utils.py:85`](../../argumentation_analysis/core/utils/text_utils.py:85)) effectue d'abord une normalisation du texte puis le divise en tokens en se basant sur les espaces.
