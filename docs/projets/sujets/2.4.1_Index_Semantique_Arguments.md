...
L'exploration de ces aspects géométriques permettra de développer une compréhension plus profonde des corpus argumentatifs et d'ouvrir la voie à des analyses plus sophistiquées.
...
## 6. Cas d'Usage Avancés et Expérimentations
...
### 6.5 Exploration des fronts de controverse
Utiliser les visualisations de l'espace sémantique pour identifier les fronts de controverse dans un débat (arguments opposés mais sémantiquement proches sur le sujet).

### 6.6 Analyse évolutive de l'espace sémantique
Analyser l'évolution de l'espace sémantique d'un corpus d'arguments au fil du temps.
