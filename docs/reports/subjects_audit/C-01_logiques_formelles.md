...
**Issue**: #779 (C-01) | **Epic**: #744 | **Date audit**: 2026-05-31
...
| 1.1.4 DL (description) | 🟢 Code exists, no subject doc | — |
| 1.1.5 QBF | 🟢 Treated (subject + code) | #745 (A-01) |
| 1.1.6 CL (conditionnelle) | 🟢 Code exists, no subject doc | — |
...
- `argumentation_analysis/plugins/tweety_logic_plugin.py` — exposition SK
