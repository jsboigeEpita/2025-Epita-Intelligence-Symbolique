...
def test_phase_d_simple():
    ...
    try:
        ...
        messages_test = [
            (
                "Sherlock",
                "J'analyse les indices présents. La logique suggère une déduction précise.",
                "analysis",
            ),
            ...
            (
                "Watson",
                "Brillant ! Suite à cette révélation, tout s'éclaire !",
                "reaction",
            ),
            (
                "Sherlock",
                "Précisément. Donc, par déduction logique, nous approchons de la solution.",
                "analysis",
            ),
        ]
