...
from argumentation_analysis.agents.core.orchestration_service import OrchestrationService, BasePlugin
...
def setup_orchestration_service_for_test():
    ...
    app.dependency_overrides[get_orchestration_service] = get_test_orchestration_service_override
...
def test_end_to_end_analysis_execution():
    ...
    response = client.post(
        "/api/v2/analyze",
        json={"text": test_text, "plugin_name": "EchoPlugin"}
    )
