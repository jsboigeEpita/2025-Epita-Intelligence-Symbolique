...
class TestAgentsToolsIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fallacy_detector.detect.return_value = [
            {
                "fallacy_type": "généralisation_hâtive",
                "confidence": 0.85,
                "context_text": "...",
            },
            {
            ...
            {
                "fallacy_type": "argument_d_autorité",
                "confidence": 0.88,
                "context_text": "...",
            },
        ]
    ...
    def test_agent_tool_configuration_validation(self):
        ...
        agent = InformalAgent(
            agent_id="test_validation", tools=valid_tools, strict_validation=False
        )
        ...
        with self.assertRaises(ValueError) as context:
            InformalAgent(agent_id="test_invalid", tools={}, strict_validation=True)
    ...
    def test_multi_tool_analysis_workflow(self):
        ...
        expected_fallacies = [
            {
                "fallacy_type": "anecdote_personnelle",
                "confidence": 0.89,
                "context_text": "mon voisin m'a dit",
            },
            {
                "fallacy_type": "généralisation_hâtive",
                "confidence": 0.92,
                "context_text": "Tous les scientifiques",
            },
            {
                "fallacy_type": "ad_hominem",
                "confidence": 0.85,
                "context_text": "payés par les compagnies",
            },
        ]
        self.fallacy_detector.detect.return_value = expected_fallacies

        # Configurer l'analyseur contextuel pour simuler une analyse contextuelle
        self.contextual_analyzer.analyze_context = MagicMock(
            return_value={
        ...
        if contextual_analysis:  # Si l'analyse contextuelle a été effectuée
            ...
            self.assertEqual(
                contextual_analysis["context_type"], "medical_misinformation"
            )
