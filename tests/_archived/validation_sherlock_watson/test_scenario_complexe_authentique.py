...
def test_full_crypto_rhetoric_pipeline(
    crypto_service, complex_rhetorical_text, tmp_path
):
    """
    ...
    encrypted_text = crypto_service.encrypt_data(
        complex_rhetorical_text.encode("utf-8")
    )
    ...
    print(
        f"Temps d'analyse rhétorique : {end_time_analysis - start_time_analysis:.4f}s"
    )
