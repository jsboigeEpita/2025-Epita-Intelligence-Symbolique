...
@pytest.fixture
def enhanced_informal_agent(complex_fallacy_analyzer, contextual_fallacy_analyzer, fallacy_severity_evaluator):
...
def extract_agent_adapter(mock_middleware):
    ...
    return ExtractAgentAdapter(agent_id="extract_agent_test", middleware=mock_middleware)
...
def real_extract_agent_adapter(real_middleware):
    ...
    return ExtractAgentAdapter(agent_id="extract_agent_test", middleware=real_middleware)


@pytest.fixture
def informal_agent_adapter(mock_middleware):
    """Fixture fournissant un adaptateur d'agent informel avec un middleware mocké."""
    return InformalAgentAdapter(agent_id="informal_agent_adapter_test", middleware=mock_middleware)
...
def real_informal_agent_adapter(real_middleware):
    ...
    return InformalAgentAdapter(agent_id="informal_agent_adapter_test", middleware=real_middleware)
