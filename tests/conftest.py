...
# NOTE: La fixture 'jvm_fixture' a été supprimée.
# Sa portée par fonction ('function') entrait en conflit avec la portée
# par session de 'jvm_session', causant des crashs 'access violation' par
# des tentatives de redémarrage illégal de la JVM. La fixture 'jvm_session'
# est maintenant `autouse=True` et devient la seule source de vérité pour le
# cycle de vie de la JVM.
