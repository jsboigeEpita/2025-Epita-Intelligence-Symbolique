...
class TestTacticalResolverAdvanced(unittest.TestCase):
        ...
        self.tactical_state.intermediate_results = {
            "task-1": {
                "identified_arguments": [
                    ...
                    {"id": "arg-2", "text": "Socrate est un homme", "confidence": 0.95},
                ],
            ...
            "task-2": {
                "identified_arguments": [
                    {"id": "arg-3", "text": "Socrate est mortel", "confidence": 0.85},
                    {
                        "id": "arg-4",
    ...
    def test_escalate_unresolved_conflicts(self):
        ...
        self.assertEqual(
            len(conflicts_to_escalate), 1
        )  # Seul le conflit non résolu devrait être escaladé
    ...
    def test_escalate_unresolved_conflicts_with_default_resolution(self):
        ...
        self.assertIsInstance(conflicts_to_escalate, list)
        self.assertEqual(
            len(conflicts_to_escalate), 2
        )  # Le conflit non résolu et celui avec résolution par défaut

        # Vérifier les détails du conflit avec résolution par défaut
        default_resolution_conflict = next(
            (c for c in conflicts_to_escalate if c["conflict_id"] == "conflict-3"), None
        )
        ...
        self.assertEqual(
            default_resolution_conflict["resolution_attempt"]["method"], "default"
        )
    ...
    def test_are_arguments_contradictory(self):
        ...
        arg1 = {"id": "arg-5", "conclusion": "Le réchauffement climatique est réel"}
        arg2 = {
            "id": "arg-6",
        ...
        arg3 = {"id": "arg-7", "conclusion": "Le réchauffement climatique est réel"}
        arg4 = {
            "id": "arg-8",
    ...
    def test_are_arguments_overlapping(self):
        ...
        arg1 = {"id": "arg-5", "subject": "réchauffement climatique"}
        arg2 = {"id": "arg-6", "subject": "réchauffement climatique et ses effets"}
        ...
        arg3 = {"id": "arg-7", "subject": "réchauffement climatique"}
        arg4 = {"id": "arg-8", "subject": "pollution plastique"}
    ...
    def test_are_formal_analyses_contradictory(self):
        ...
        analysis1 = {"id": "analysis-1", "argument_id": "arg-1", "is_valid": True}
        analysis2 = {"id": "analysis-2", "argument_id": "arg-1", "is_valid": False}
        ...
        analysis3 = {"id": "analysis-3", "argument_id": "arg-1", "is_valid": True}
        analysis4 = {"id": "analysis-4", "argument_id": "arg-2", "is_valid": False}
    ...
    def test_check_formal_analysis_conflicts(self):
        ...
        conflicts = self.resolver._check_formal_analysis_conflicts(
            analyses, existing_results
        )
        ...
        self.assertEqual(
            conflict["description"], "Contradiction dans les analyses formelles"
        )
        self.assertEqual(conflict["severity"], "high")
