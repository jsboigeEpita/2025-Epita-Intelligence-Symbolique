...
class TestMainOrchestrator:
    ...
    async def test_run_analysis_selects_and_executes_correct_strategy(self, mock_select_strategy, orchestrator):
        """
    ...
    @patch('argumentation_analysis.orchestration.engine.main_orchestrator.select_strategy')
    async def test_run_analysis_routes_to_all_strategies(self, mock_select_strategy, strategy, method_name, orchestrator):
        """
    ...
    @patch('argumentation_analysis.orchestration.engine.main_orchestrator.select_strategy')
    async def test_run_analysis_handles_unknown_strategy(self, mock_select_strategy, orchestrator):
        """
