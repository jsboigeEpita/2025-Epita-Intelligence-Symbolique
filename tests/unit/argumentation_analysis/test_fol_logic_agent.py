...
class TestFOLLogicAgent:
    ...
    @pytest.fixture
    def fol_agent(self, mocker):
        """Provides a FOLLogicAgent instance with a mocked kernel."""
        mock_kernel = mocker.patch("semantic_kernel.Kernel", autospec=True)
        return FOLLogicAgent(kernel=mock_kernel)
    ...
    async def test_process_translation_task_success(self, fol_agent):
        ...
        fol_agent.text_to_belief_set = AsyncMock(
