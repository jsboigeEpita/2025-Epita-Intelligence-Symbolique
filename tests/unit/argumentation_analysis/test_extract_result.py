...
def test_is_rejected(valid_extract_result, error_extract_result, rejected_extract_result):
...
def test_str_representation(valid_extract_result, error_extract_result, rejected_extract_result):
