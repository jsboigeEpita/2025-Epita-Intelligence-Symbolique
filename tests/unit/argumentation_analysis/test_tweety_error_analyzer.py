...
class TestTweetyErrorAnalyzer:
    ...
    def test_analyze_modal_syntax_error(self):
        ...
        assert any(
            "modal" in rule.lower() or "modaux" in rule.lower()
    ...
    def test_generate_bnf_corrections_declaration_error(self):
        ...
        feedback = self.analyzer.analyze_error(
            "Predicate 'smart' has not been declared"
        )
        ...
        assert (
            "constant smart" in feedback.example_fix
            or "prop(smart)" in feedback.example_fix
        )
    ...
    def test_generate_bnf_corrections_modal_error(self):
        ...
        assert (
            "modal" in corrections_text.lower() or "modaux" in corrections_text.lower()
        )
    ...
    def test_error_pattern_matching(self):
        ...
        test_cases = [
            ...
            ),  # Pattern exact avec parenthèses
