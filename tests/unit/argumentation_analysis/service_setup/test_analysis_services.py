...
def test_initialize_services_llm_fails_returns_none(mock_settings, mock_create_llm, mock_init_jvm, mock_load_dotenv, mock_find_dotenv, caplog):
...
def test_initialize_services_llm_fails_raises_exception(mock_settings, mock_create_llm, mock_init_jvm, mock_load_dotenv, mock_find_dotenv, caplog):
