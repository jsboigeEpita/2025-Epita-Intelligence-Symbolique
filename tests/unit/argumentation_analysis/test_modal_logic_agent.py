...
class TestModalLogicAgentIntegration:
    ...
    async def test_full_analysis_workflow(self, integration_agent):
        ...
        integration_agent._tweety_bridge.execute_modal_query.side_effect = [
