...
def test_load_single_plugin_no_dependencies(mock_import_module, plugin_test_env):
    ...
    manifest = {"name": "PluginA", "entrypoint_module": "plugin_a", "entrypoint_class": "MockPluginA"}
...
def test_load_plugins_with_valid_dependencies(mock_import_module, plugin_test_env):
    ...
    manifest_a = {"name": "PluginA", "entrypoint_module": "plugin_a", "entrypoint_class": "MockPluginA"}
    create_fake_plugin(fs, plugins_root, manifest_a)
    
    manifest_b = {"name": "PluginB", "dependencies": ["PluginA"], "entrypoint_module": "plugin_b", "entrypoint_class": "MockPluginB"}
...
def test_load_plugins_with_circular_dependency_raises_error(plugin_test_env):
    ...
    manifest_a = {"name": "PluginA", "dependencies": ["PluginB"], "entrypoint_module": "plugin_a", "entrypoint_class": "MockPluginA"}
    create_fake_plugin(fs, plugins_root, manifest_a)
