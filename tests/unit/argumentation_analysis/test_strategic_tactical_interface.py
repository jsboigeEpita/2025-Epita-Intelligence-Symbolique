...
class TestStrategicTacticalInterface:
    ...
    def interface_components(self, mocker):
        ...
        mock_strategic_state.global_metrics = {
            "progress": 0.4,
            "quality": 0.7,
        ...
        return (
            interface,
            mock_strategic_state,
            mock_tactical_state,
            mock_middleware,
            mock_strategic_adapter,
            mock_tactical_adapter,
        )
    ...
    def test_process_tactical_report(self, interface_components):
        ...
        tactical_report = {
            ...
            "progress_by_objective": {
                "obj-1": {"total_tasks": 5, "completed_tasks": 4, "progress": 0.8},
                "obj-2": {"total_tasks": 3, "completed_tasks": 2, "progress": 0.7},
                "obj-3": {"total_tasks": 2, "completed_tasks": 0, "progress": 0.1},
            },
            "issues": [
                {
                    "type": "blocked_task",
            ...
            "conflicts": {"total": 2, "resolved": 1},
            "metrics": {"agent_utilization": {"agent-1": 0.9, "agent-2": 0.5}},
        }
    ...
    def test_find_related_objectives(self, interface_components):
        ...
        assert (
            "obj-2" in result
        )  # Car "arguments" est présent dans les deux descriptions
    ...
    def test_request_tactical_status(self, interface_components):
        ...
        expected_response = {"status": "ok", "progress": 0.5}
        mock_strategic_adapter.request_tactical_info.return_value = (
            expected_response  # Corrigé ici
        )
    ...
    def test_send_strategic_adjustment(self, interface_components):
        ...
        adjustment = {"plan_updates": {"phase-1": {"priority": "high"}}, "urgent": True}

        # Configurer le mock pour send_directive
        mock_strategic_adapter.issue_directive.return_value = (
            "message-id-123"  # Corrigé ici
        )
