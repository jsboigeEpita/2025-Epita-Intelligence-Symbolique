...
def balanced_strategy_fixture(monkeypatch):
    ...
    mock_fetch_service.fetch_text.return_value = (
        "Texte source avec DEBUT_EXTRAIT contenu FIN_EXTRAIT.",
...
class TestExtractIntegrationWithBalancedStrategy:
    ...
    def test_extract_integration_with_balanced_strategy(
        self, balanced_strategy_fixture
    ):
        async def run_test():
            (
                state,
