...
class TestPrebuiltWorkflows:
    ...
    def test_build_standard_workflow(self):
        """Standard workflow has 17 phases (kb chain #2296 + narrative_synthesis #981 + local_llm #835)."""
        from argumentation_analysis.orchestration.unified_pipeline import (
        ...
        assert len(wf.phases) == 17  # kb belief-set chain wired in #2296
...
class TestInvokeCallables:
    ...
    async def test_invoke_quality_evaluator(self, monkeypatch):
        ...
        # #2588 review-2 — la langue du document est passée aussi ; "Test arg"
        # est trop court pour décider : None, jamais une langue devinée.
        mock_evaluator.evaluate.assert_called_once_with(
            "Test arg", lang=None, context_level=None
        )
