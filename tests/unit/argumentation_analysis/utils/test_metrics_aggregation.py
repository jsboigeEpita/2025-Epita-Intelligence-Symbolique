...
from argumentation_analysis.utils.metrics_aggregation import (
    ...
    return [
        {
            ...
            "analyses": {
                "contextual_fallacies": {
                    ...
                    "contextual_factors": {"cf1": 1, "cf2": 2},
                    "analysis_timestamp": "2023-01-01T10:00:10",
                },
                "argument_coherence": {
                    "overall_coherence": {"score": 0.8},
                    "recommendations": ["r1"],
                    "coherence_evaluations": {"e1": {}},
                    "analysis_timestamp": "2023-01-01T10:00:05",
                },
    ...
    return [
        {
            ...
            "analyses": {
                "contextual_fallacies": {
                    "contextual_fallacies": [
                        {"fallacy_type": "F_AdvCtx1", "confidence": 0.9}
                    ],
                    "contextual_fallacies_count": 1,
                    "context_analysis": {
                        "context_type": "Debate",
                        "context_subtypes": ["Pol"],
                    },
                    "analysis_timestamp": "2023-01-01T10:00:20",
                },
                "complex_fallacies": {
                    "individual_fallacies_count": 1,
                    "basic_combinations": [{}],
                    "composite_severity": {"severity_level": "Élevé"},
                    "analysis_timestamp": "2023-01-01T10:00:30",
                },
                "fallacy_severity": {
                    "overall_severity": 0.7,
                    "analysis_timestamp": "2023-01-01T10:00:25",
                },
                "rhetorical_results": {
                    "overall_analysis": {
                    ...
                    "recommendations": {"coherence_recommendations": ["ar1", "ar2"]},
                    "analysis_timestamp": "2023-01-01T10:00:40",
                },
            },
        }
    ]
...
def test_generate_performance_metrics_for_agents_structure(
    ...
    metrics = generate_performance_metrics_for_agents(
        sample_base_results_for_metrics, sample_advanced_results_for_metrics
    )
...
def test_generate_performance_metrics_for_agents_calculations(
    ...
    assert (
        "relevance" not in metrics["advanced_rhetorical"]
        or metrics["advanced_rhetorical"]["relevance"] == 0.0
    )
