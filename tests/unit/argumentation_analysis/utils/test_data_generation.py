...
def test_generate_sample_text_lincoln_in_extract_name():
    ...
    text = generate_sample_text(
        extract_name="Discours de Lincoln", source_name="Quelconque"
    )
...
def test_generate_sample_text_lincoln_in_source_name():
    ...
    text = generate_sample_text(
        extract_name="Un discours", source_name="Source: Abraham Lincoln"
    )
    assert LINCOLN_EXPECTED_SUBSTRING in text
...
def test_generate_sample_text_debat_in_extract_name():
    ...
    text = generate_sample_text(
        extract_name="Grand Débat National", source_name="Quelconque"
    )
...
def test_generate_sample_text_discours_in_extract_name():
    ...
    text = generate_sample_text(
        extract_name="Discours inaugural", source_name="Quelconque"
    )
    assert DEBATE_SPEECH_EXPECTED_SUBSTRING in text
...
def test_generate_sample_text_hitler_in_source_name():
    ...
    text = generate_sample_text(
        extract_name="Un extrait", source_name="Discours d'Hitler"
    )
    assert (
        DEBATE_SPEECH_EXPECTED_SUBSTRING in text
    )  # La logique actuelle regroupe Hitler avec Débat/Discours
...
def test_generate_sample_text_hitler_in_extract_name_lower():
    ...
    text = generate_sample_text(
        extract_name="discours hitlerien", source_name="Archives"
    )
    assert DEBATE_SPEECH_EXPECTED_SUBSTRING in text
...
def test_generate_sample_text_churchill_in_source_name():
    ...
    text = generate_sample_text(
        extract_name="Un extrait", source_name="Discours de Churchill"
    )
    assert DEBATE_SPEECH_EXPECTED_SUBSTRING in text
...
def test_generate_sample_text_churchill_in_extract_name_lower():
    ...
    text = generate_sample_text(
        extract_name="paroles de churchill", source_name="Histoire"
    )
    assert DEBATE_SPEECH_EXPECTED_SUBSTRING in text
...
def test_generate_sample_text_default_case():
    ...
    text = generate_sample_text(
        extract_name="Texte générique", source_name="Source quelconque"
    )
