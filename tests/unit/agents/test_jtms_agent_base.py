...
class TestJTMSSession:
    ...
    def test_update_belief_confidence(self):
        ...
        belief.record_modification(
            "confidence_updated", {"old_confidence": 0.5, "new_confidence": 0.9}
        )
...
class TestJTMSAgentBase:
    ...
    async def test_add_belief(self, test_agent):
        ...
        context = {"type": "evidence", "source": "observation"}
...
def test_extended_belief_modification_tracking():
    ...
    belief.record_modification(
        "confidence_update",
        {"old_confidence": 0.5, "new_confidence": 0.8, "reason": "Mise à jour test"},
    )
