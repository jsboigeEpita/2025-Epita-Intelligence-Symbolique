...
from project_core.pipelines.diagnostic_pipeline import run_environment_diagnostic_pipeline, EnvironmentDiagnostic
...
@patch('project_core.pipelines.diagnostic_pipeline.setup_logging')
@patch('project_core.pipelines.diagnostic_pipeline.EnvironmentDiagnostic')
@patch('project_core.pipelines.diagnostic_pipeline.Path')
def test_run_diagnostic_pipeline_success(
    ...
    with patch('project_core.pipelines.diagnostic_pipeline.logger', mock_logger_diag_fixture):
