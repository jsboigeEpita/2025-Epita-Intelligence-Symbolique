...
@patch('project_core.pipelines.dependency_management_pipeline.setup_logging')
@patch('project_core.pipelines.dependency_management_pipeline.run_shell_command')
@patch('project_core.pipelines.dependency_management_pipeline.Path')
...
@patch('project_core.pipelines.dependency_management_pipeline.Path')
@patch('builtins.open', new_callable=mock_open)
@patch('project_core.pipelines.dependency_management_pipeline.sys') # Pour mocker sys.executable
...
@patch('project_core.pipelines.dependency_management_pipeline.Path')
@patch('builtins.open', new_callable=mock_open)
@patch('project_core.pipelines.dependency_management_pipeline.sys')
