...
def mock_logger_setup_fixture():
    ...
    with patch('project_core.pipelines.setup_pipeline.logger') as mock_log:
        yield mock_log

@patch('project_core.pipelines.setup_pipeline.run_download_jars_pipeline')
@patch('project_core.pipelines.setup_pipeline.run_dependency_installation_pipeline')
@patch('project_core.pipelines.setup_pipeline.setup_jpype_mock')
@patch('project_core.pipelines.setup_pipeline.Path') # Pour mocker Path() et ses instances
...
@patch('project_core.pipelines.setup_pipeline.run_dependency_installation_pipeline')
@patch('project_core.pipelines.setup_pipeline.setup_jpype_mock')
@patch('project_core.pipelines.setup_pipeline.Path')
