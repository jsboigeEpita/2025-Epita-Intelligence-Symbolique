...
def mock_logger_download_fixture():
    ...
    with patch('project_core.pipelines.download_pipeline.logging') as mock_log_module:
        yield mock_log_module

@patch('project_core.pipelines.download_pipeline.download_file')
@patch('project_core.pipelines.download_pipeline.Path') # Pour mocker Path() et ses instances
...
@patch('project_core.pipelines.download_pipeline.download_file')
@patch('project_core.pipelines.download_pipeline.Path')
