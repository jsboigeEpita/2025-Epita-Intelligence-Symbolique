...
def test_argument_reconstruction_workflow(page: Page, frontend_url: str):
    ...
    expect(results_container).to_contain_text("Tous les hommes sont mortels", timeout=5000)
...
def test_reconstructor_content_persistence(page: Page, frontend_url: str):
    ...
    expect(results_container).to_contain_text("les pingouins ont des ailes", timeout=10000)
