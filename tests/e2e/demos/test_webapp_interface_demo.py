...
class TestWebAppInterfaceDemo:
    ...
    def test_example_button_functionality(self, page: Page):
        ...
        expect(text_input).to_have_value(
            "Si tous les hommes sont mortels, et que Socrate est un homme, alors Socrate est mortel. Cet argument est valide car il suit la structure logique du syllogisme."
        )
    ...
    def test_empty_text_validation(self, page: Page):
        ...
        expect(page.locator("#status")).to_contain_text(
            "Veuillez entrer du texte a analyser"
        )
