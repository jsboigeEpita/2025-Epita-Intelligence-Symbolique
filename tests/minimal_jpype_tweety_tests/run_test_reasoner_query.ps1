# Script PowerShell pour exécuter test_reasoner_query.py avec CLASSPATH configuré
$ErrorActionPreference = "Stop"

Write-Host "--- Début de l'exécution de run_test_reasoner_query.ps1 ---"
...
$TestScript = Join-Path -Path $PSScriptRoot -ChildPath "test_reasoner_query.py" # MODIFIÉ ICI
...
Write-Host "--- Fin de l'exécution de run_test_reasoner_query.ps1 ---"