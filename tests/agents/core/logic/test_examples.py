...
@pytest.mark.skip(
    reason="Legacy examples do not exist anymore. Replaced by notebooks and new demos."
)
class TestLogicExamples:
    ...
    async def asyncSetUp(self):
        ...
        self.tweety_bridge_patcher = patch(
        ...
        self.mock_tweety_bridge.validate_belief_set.return_value = (
            True,
            "Ensemble de croyances valide",
        )
        self.mock_tweety_bridge.validate_formula.return_value = (True, "Formule valide")
        self.mock_tweety_bridge.validate_fol_belief_set.return_value = (
            True,
            "Ensemble de croyances FOL valide",
        )
        self.mock_tweety_bridge.validate_fol_formula.return_value = (
            True,
            "Formule FOL valide",
        )
        self.mock_tweety_bridge.validate_modal_belief_set.return_value = (
            True,
            "Ensemble de croyances modal valide",
        )
        self.mock_tweety_bridge.validate_modal_formula.return_value = (
            True,
            "Formule modale valide",
        )
    ...
    async def test_combined_logic_example(self):
        ...
        with patch("builtins.print"):  # Supprimer les sorties
            ...
            try:
                ...
                self.fail(
                    f"L'exemple combinant différents types de logique a échoué: {str(e)}"
                )
