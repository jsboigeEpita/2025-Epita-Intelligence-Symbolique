...
def test_watson_logic_assistant_instanciation(agent_factory: AgentFactory, mock_tweety_bridge: MagicMock) -> None:
    """
...
def test_watson_logic_assistant_instanciation_with_custom_prompt(agent_factory: AgentFactory, mock_tweety_bridge: MagicMock) -> None:
    """
...
def test_watson_logic_assistant_default_name_and_prompt(agent_factory: AgentFactory, mock_tweety_bridge: MagicMock) -> None:
    """
...
@pytest.mark.asyncio
async def test_get_agent_belief_set_content(agent_factory: AgentFactory, mock_tweety_bridge: MagicMock) -> None:
    """
