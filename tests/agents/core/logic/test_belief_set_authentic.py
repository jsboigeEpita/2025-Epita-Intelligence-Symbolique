...
class TestBeliefSetAuthentic:
    ...
    def test_from_dict_propositional_authentic(self):
        ...
        data = {"logic_type": "propositional", "content": "a => b & (c | d)"}
    ...
    def test_from_dict_first_order_authentic(self):
        ...
        assert (
            belief_set.content == "forall X: (Human(X) => Mortal(X)) & Human(socrate)"
        )
    ...
    def test_from_dict_modal_authentic(self):
        ...
        data = {"logic_type": "modal", "content": "[]p => <>q & [](r => s)"}
    ...
    def test_from_dict_edge_cases_authentic(self):
        ...
        unsupported_data = {"logic_type": "quantum_logic", "content": "entangled(a, b)"}
