...
class TestQueryExecutor:
    ...
    async def async_setUp(self):
        ...
        with patch(
            ...
            with patch.object(QueryExecutor, "__init__", lambda s: None):
                ...
                self.query_executor._tweety_bridge = (
                    mock_tweety_bridge_class.return_value
                )
    ...
    async def test_execute_query_modal_accepted(self):
        ...
        self.mock_tweety_bridge.modal_handler.validate_modal_formula.return_value = (
            True,
            "OK",
        )
        self.mock_tweety_bridge.modal_handler.execute_modal_query.return_value = (
        ...
        self.mock_tweety_bridge.modal_handler.validate_modal_formula.assert_called_once_with(
            "[]p"
        )
        self.mock_tweety_bridge.modal_handler.execute_modal_query.assert_called_once_with(
            "[]p => <>q", "[]p"
        )
