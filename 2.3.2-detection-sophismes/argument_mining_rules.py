...
claim_patterns = [
    ...
    {"PATTERN": [{"LOWER": {"IN": ["je", "nous"]}}, {"LEMMA": {"IN": ["penser", "croire", "affirmer"]}}, {"LOWER": "que"}, {"OP": "+"}]},
    # Pattern 2: Phrases indicating a conclusion: "Donc...", "Par conséquent...", "En conclusion..."
    {"PATTERN": [{"LOWER": {"IN": ["donc", "par", "en"]}}, {"LOWER": {"IN": ["conséquent", "conclusion"]}}, {"IS_PUNCT": True, "OP": "?"}, {"OP": "+"}]},
...
premise_patterns = [
    ...
    {"PATTERN": [{"LOWER": {"IN": ["parce", "car", "étant"]}}, {"LOWER": {"IN": ["que", "donné"]}}, {"OP": "+"}]},
    # Pattern 2: "Selon [source]...", "D'après [source]..."
    {"PATTERN": [{"LOWER": {"IN": ["selon", "d'après"]}}, {"POS": "NOUN"}, {"OP": "+"}]},
    # Pattern 3: "Les faits montrent que...", "Des études indiquent que..."
    {"PATTERN": [{"LOWER": {"IN": ["les", "des"]}}, {"POS": "NOUN"}, {"LEMMA": {"IN": ["montrer", "indiquer"]}}, {"LOWER": "que"}, {"OP": "+"}]},
]
