...
class FallacyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            'labels': torch.tensor(raw_labels, dtype=torch.long) # Change to long for single-label
        }

# 3. Initialize Tokenizer and Model
print("Initializing tokenizer and model...")
tokenizer = CamembertTokenizer.from_pretrained('camembert/camembert-large')
model = CamembertForSequenceClassification.from_pretrained('camembert/camembert-large', num_labels=num_labels)
