...
def demo_service_manager():
    ...
    test_service = ServiceConfig(
        name="service-demo",
        command=["python", "-c", "import time; print('Service démarré'); time.sleep(2)"],
        working_dir=".",
        port=port,
    ...
    print("[OK] Pattern Failover: Adapte dans ServiceManager.start_service_with_failover()")
    print("[OK] Pattern Test-Integration: Adapte dans TestRunner.run_integration_tests_with_failover()")
...
def print_migration_summary():
    ...
    print("2. backend_failover_non_interactive.ps1 -> Logique intégrée dans ServiceManager")
    print("3. run_backend.cmd -> run_backend_replacement.py")
    print("4. run_frontend.cmd -> run_frontend_replacement.py")
    print("5. integration_tests_with_failover.ps1 -> TestRunner.run_integration_tests_with_failover()")
