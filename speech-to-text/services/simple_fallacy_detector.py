...
def detect_fallacies_simple(text: str) -> Dict[str, Any]:
    ...
    fallacy_patterns = {
        ...
        "False Cause": [r"if.*were.*then why", r"because.*was.*last.*winter"],
        "Hasty Generalization": [r"all.*are.*just", r"everyone.*is"],
        "Straw Man": [r"based on.*false claims", r"these.*claims"],
    }
    ...
    analysis_result["recommendations"] = [
        r for r in analysis_result["recommendations"] if r is not None
    ]
