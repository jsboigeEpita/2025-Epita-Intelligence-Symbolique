...
class WhisperApiClient {
  ...
  async transcribeFile(file, options = {}) {
    const defaultOptions = {
      input_folder_path: "Hello!!",
      include_subdirectory: true,
      save_same_dir: true,
      file_format: "SRT",
      add_timestamp: true,
      progress: "tiny.en", // model
      param_7: "english", // language
      param_8: true, // use_auth_token
      param_9: 3, // chunk_length
      param_10: 3, // stride_length_s
      param_11: 3, // max_new_tokens
      param_12: "float16", // dtype
      param_13: 5, // batch_size
      param_14: 1, // assistant_model
      param_15: true, // use_bettertransformer
      param_16: 0.5, // flash_attention_2
      param_17: "Hello!!", // preprocess_text
      param_18: 0, // postprocess_text
      param_19: 2.4, // temperature
      param_20: 1, // compression_ratio_threshold
      param_21: 1, // log_prob_threshold
      param_22: 0, // no_speech_threshold
      param_23: "Hello!!", // initial_prompt
      param_24: true, // suppress_tokens
      param_25: "[-1]", // suppress_numerals
      param_26: 1, // max_initial_timestamp
      param_27: false, // word_timestamps
      param_28: "'\"¿([{-", // prepend_punctuations
      param_29: "'.。,，!！?？:：\")]}、", // append_punctuations
      param_30: 3, // max_line_width
      param_31: 30, // max_line_count
      param_32: 3, // max_words_per_line
      param_33: "Hello!!", // highlight_words
      param_34: 0.5, // segment_resolution
      param_35: 1, // fonts_size
      param_36: 24, // fonts_color
      param_37: true, // karaoke
      param_38: false, // embed_subs
      param_39: 0.5, // similarity_threshold
      param_40: 250, // min_word_dur
      param_41: 9999, // only_voice_freq
      param_42: 1000, // min_words_per_segment
      param_43: 2000, // min_words_per_segment_threshold
      param_44: false, // time_sync_adjustment
      param_45: "cuda", // device
      param_46: this.apiKey, // hugging_face_token
      param_47: true, // use_cache
      param_48: false, // delete_cache
      param_49: "UVR-MDX-NET-Inst_HQ_4", // uvr_model
      param_50: "cuda", // uvr_device
      param_51: 256, // uvr_segment_size
      param_52: false, // uvr_save_file
      param_53: true // bgm_separation
    };
    ...
    try {
      ...
      const result = await client.predict("/transcribe_file", {
        files: file,
        input_folder_path: finalOptions.input_folder_path,
        include_subdirectory: finalOptions.include_subdirectory,
        save_same_dir: finalOptions.save_same_dir,
        file_format: finalOptions.file_format,
        add_timestamp: finalOptions.add_timestamp,
        progress: finalOptions.progress,
        param_7: finalOptions.param_7,
        ...
        param_49: finalOptions.param_49,
        param_50: finalOptions.param_50,
        param_51: finalOptions.param_51,
        param_52: finalOptions.param_52,
        param_53: finalOptions.param_53
      });
